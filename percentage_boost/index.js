$(document).ready(function () {
  $("#calculate_btn").click(function () {
    ...
    var odd_boost = $("#odd_boost").is(":checked");
    var odd_boost_1 = odd_to_boost + (odd_to_boost * boost_percentage) / 100;
    var profit_boost_1 =
      (odd_to_boost - 1) * (boost_percentage / 100) + odd_to_boost;
    var odd1 = odd_to_boost + (odd_to_boost * boost_percentage) / 100;
    var odd1 = odd_boost ? odd_boost_1 : profit_boost_1;
